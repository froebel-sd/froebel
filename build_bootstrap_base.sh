...
basepkgs="filesystem musl linux-headers netbsd-csu mksh zlib libressl curl libffi clang-headers ncurses python libcxxabi-headers libcxx-headers compiler-rt libunwind libcxxabi libcxx llvm rhash clang lld ninja gmake pigz libarchive libcap getopt fakeroot diffutils bmake cmake perl git"
